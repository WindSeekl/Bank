...
document
		.write('<header id="header">'
				...
				+ '			<span> <a href="./" data-placement="left" data-content="退出"><i'
        ...
        + '			<span id="sysUserId">欢迎您&nbsp;{{denglujieguo[0].Truename}}</span>'
        + '			&nbsp;&nbsp;&nbsp; <span class="hidden-xs" id="sysRoleId">角色:{{denglujieguo[0].role}}'
				+ '			</span>&nbsp;&nbsp;&nbsp;' + '		</div>'
