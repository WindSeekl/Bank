...
document
		.write('<aside id="left-panel">'
				...
				+ '				<ul>'
        + '					<li id="panelUserInfo"><a href="/plan/userInfo">用户信息</a></li>'
        + '					<li id="panelPasswordUpdate"><a href="/plan/passwordUpdate">修改密码</a></li>'
				+ '				</ul></li>'
				+ '			<li><a href="#"><i class="fa fa-lg fa-fw fa-file-text"></i>'
				+ '					<span class="menu-item-parent">营销管理</span></a>'
				+ '				<ul>'
				+ '					<li id="saleChanceList"><a href="/salechance/saleChanceList">销售机会管理</a></li>'
        + '					<li id="planSaleChanceList"><a href="/plan/saleChanceList">开发计划管理</a></li>'
				+ '				</ul></li>'
				+ '			<li><a href="#"><i class="fa fa-lg fa-fw fa-user"></i> <span'
				+ '					class="menu-item-parent">客户管理</span></a>'
				+ '				<ul>'
        + '					<li id="customerList"><a href="/customer/customerList">客户资料管理</a></li>'
        + '					<li id="customerLostList"><a href="/customerlost/customerLostList">客户流失管理</a></li>'
				+ '				</ul></li>'
				+ '			<li><a href="#"><i class="fa fa-lg fa-fw fa-qrcode"></i> <span'
				+ '					class="menu-item-parent">服务管理</span></a>'
				+ '				<ul>'
        + '					<li id="serviceList"><a href="/service/serviceList">服务维护</a></li>'
        + '					<li id="serviceDueList"><a href="/service/serviceDueList">服务分配</a></li>'
        + '					<li id="serviceDealList"><a href="/service/serviceDealList">服务处理 </a></li>'
        + '					<li id="serviceSatisfyList"><a href="/service/serviceSatisfyList">服务反馈 </a></li>'
        + '					<li id="serviceInfoList"><a href="/service/serviceInfoList">服务归档</a></li>'
				+ '				</ul></li>'
				+ '			<li><a href="#"><i class="fa fa-lg fa-fw fa-bar-chart-o"></i>'
				+ '					<span class="menu-item-parent">统计报表</span></a>'
				+ '				<ul>'
				+ '					<li id="orderReport"><a href="/report/orderReport">客户贡献报表</a></li>'
				+ '					<li id="customerReport"><a href="/report/customerReport">客户构成报表</a></li>'
				+ '					<li id="serviceReport"><a href="/report/serviceReport">客户服务报表</a></li>'
				+ '					<li id="customerLostReport"><a href="/report/customerLostReport">客户增减报表</a></li>'
				+ '				</ul></li>'
				+ '			<li><a href="#"><i class="fa fa-lg fa-fw fa-cog"></i> <span'
				+ '					class="menu-item-parent">系统管理</span></a>'
				+ '				<ul>'
        + '					<li id="userList"><a href="/userlist">用户管理</a></li>'
				+ '				</ul></li>' + '		</ul>' + '	</nav>'
